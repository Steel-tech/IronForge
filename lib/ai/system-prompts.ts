...
export function buildSystemPrompt(
  ...
  const stateName = profile.state === "WA" ? "Washington State" : profile.state === "OR" ? "Oregon" : "their state";
...
4. If the user asks about the other state (WA vs OR), briefly note the difference and suggest they switch states in their profile for detailed guidance.
